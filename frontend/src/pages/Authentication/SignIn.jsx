  ...
  const submission = (data) => {
    AxiosInstance.post(`api/login/`, {
      ...
      .then((response) => {
        ...
        const { is_rh, is_employe, is_candidat } = response.data.user;
        localStorage.setItem('UserRole', JSON.stringify({ is_rh, is_employe, is_candidat }));
  
        // Redirect to a standard dashboard route
        navigate(`/dashboard`);
      })
      .catch((error) => {
        setShowMessage(true);
