...
function SignUp() {
    ...
    const handleSubmit = async (e) => {
      ...
      signupData.append('password2', formData.password2);
      if (formData.profile_picture) {
          signupData.append('profile_picture', formData.profile_picture);
      }
  
      try {
          const response = await AxiosInstance.post('api/signup/candidat/', signupData, {
              headers: {
          ...
          if (err.response && err.response.data) {
              ...
              setError({"general": ["Une erreur s'est produite lors de l'inscription."]});
          }
          setSuccess(null);
      }
  };
